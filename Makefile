...
BIN		= echo pwd dest test elftest 
...
dest.o : dest.c ../include/type.h ../include/stdio.h
	$(CC) $(CFLAGS) -o $@ $<

dest : dest.o start.o $(LIB)
	$(LD) $(LDFLAGS) -o $@ $?

elftest.o : elftest.c ../include/type.h ../include/stdio.h 
	$(CC) $(CFLAGS) -g  -o $@ $<

elftest : elftest.o start.o $(LIB) 
	$(LD) $(LDFLAGS) -o $@ $?
